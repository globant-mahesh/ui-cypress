        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    console.log("A message was posed to conversation ".concat(res.channel, " with id ").concat(res.ts, " which contains the message ").concat(res.message));
                    return [2 /*return*/];
            }
        });
    }); })();
